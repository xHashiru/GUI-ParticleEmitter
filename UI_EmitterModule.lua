...
Scale is normally 1. If an effect appears too big and the speed is off try to reduce the scale.
...
The GUI effect is an ImageLabel that uses !UDim2.Offset! for the effects, not UDim2.Scale!
If you want me to do a UDim2.Scale conversion hit me up, shouldn't be too much of a hassle.

Also if anything doesnt work as expected, be sure to DM me about that.
